...
def setup_args():
    ...
    parser.add_argument('--new-name', help="New name of the virtual machine.")
...
def add_ovf_env(host, user, password, port, vm_name,
                ignition_config, new_name, **kwargs):
    ...
    tasks.wait_for_tasks(si, [vm.ReconfigVM_Task(spec), vm.Rename(new_name)])
